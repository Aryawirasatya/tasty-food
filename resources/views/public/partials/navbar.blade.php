...
>
  <div class="max-w-7xl mx-auto px-6 py-6 flex justify-between items-center">
    {{-- Logo / Brand --}}
    <a href="{{ route('home') }}" class="text-2xl font-extrabold uppercase">
      TASTY FOOD
    </a>
    ...
    {{-- Menu Desktop --}}
    <ul class="hidden md:flex space-x-8 text-sm font-medium uppercase">
  ...
  <div
    ...
    class="md:hidden px-6 pb-4 bg-transparent text-white"
  >
